...
"""Load datasets"""
mpii = MpiiSinglePerson('/mnt/hdd3tb/Users/hoang/viet/MPII', dataconf=mpii_dataconf,
        poselayout=pa16j2d)
...
"""Save model callback."""
save_model = SaveModel('/home/vietnguyen/new_deephar/output/weights_mpii+penn_ar_{epoch:03d}.hdf5', model_to_save=full_model)
